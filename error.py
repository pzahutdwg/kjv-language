def error(line=None, wholeLine=None, type=None, term=None):
    if type == 'declaration':
        ...
        print(f'Woe unto thee, for the term "{term}" was called, yet it was not declared. Neither was it known in the land, nor found among the names of the defined. "{term}" was as a voice crying in the wilderness, and there was none to answer.')
    elif type == 'declaration':
        print(f'Line {line} was defiled with an improper declaration; and the term {term} was the worker of iniquity. By its hand the error came, and the execution of the code was stayed.')
    elif line:
